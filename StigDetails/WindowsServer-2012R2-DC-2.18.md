...
| V-2376 | Medium | AccountPolicyRule | AccountPolicy |  | Kerberos-User Logon Restrictions |
| V-2377 | Medium | AccountPolicyRule | AccountPolicy |  | Kerberos-Service Ticket Lifetime |
| V-2378 | Medium | AccountPolicyRule | AccountPolicy |  | Kerberos - User Ticket Lifetime |
| V-2379 | Medium | AccountPolicyRule | AccountPolicy |  | Kerberos-User Ticket Renewal |
| V-2380 | Medium | AccountPolicyRule | AccountPolicy |  | Kerberos - Computer Clock Sync |
...
| V-26531 | Medium | AuditPolicyRule | AuditPolicySubcategory |  | Audit - Computer Account Management - Success |
...
| V-30016 | Medium | UserRightRule | UserRightsAssignment |  | Add workstations to domain |
...
| V-8326 | Medium | ManualRule | Directory Server Host Dedication |
